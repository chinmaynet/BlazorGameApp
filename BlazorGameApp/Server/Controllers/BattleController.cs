...
namespace BlazorGameApp.Server.Controllers
{
    ...
    public class BattleController : ControllerBase
    {
        ...
        private async Task Fight(User attacker, User opponent, BattleResult result)
        {
            ...
            var attackerDamageSum = 0; //damageDoneByAttacker
            var opponentDamageSum = 0; //damageDoneByOppponent
            ...
            while (attackerArmy.Count > 0 && opponentArmy.Count > 0)
            {
                ...
                if (currentRound % 2 != 0) //odd round 1, 3, 5
            ...
            List<UserUnit> attackerArmy, List<UserUnit> opponentArmy, BattleResult result)
        {
            ...
            var damage =
                ...
                //randomAttacker.unit.Attack -randomOpponent.unit.Defence;
